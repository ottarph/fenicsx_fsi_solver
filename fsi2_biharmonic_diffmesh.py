...
def main():
    ...
    def A_T(u, u_old, v, v_old):
        ...
        residual += delta * rho_s * ufl.inner((u - u_old) / dt, du) * dx_solid
    ...
    def A_I(u, v, z):
        ...
        alpha_u0 = dfx.fem.Constant(mesh, 1.0e-2)
        alpha_u = alpha_u0
        ...
        # residual -= ufl.inner(alpha_u * ufl.grad(z) * normal, du) * ds_interface_fluid #TODO: Should be included i think, check results.
    ...
    def A_E(u, v):
        ...
        residual -= delta * rho_s * ufl.inner(v, du) * dx_solid
    ...
    disp_path = "output/fsi2_biharm_Adisp.txt"
