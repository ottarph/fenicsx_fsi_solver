...
def main():
    ...
    delta_u, delta_z, delta_v, delta_p = ufl.TrialFunctions(W)
    ...
    offset_2 = Z.dofmap.index_map.size_local * Z.dofmap.index_map_bs
    offset_3 = V.dofmap.index_map.size_local * V.dofmap.index_map_bs
    ...
    while step < max_steps:
        ...
        x.array[offset_1:(offset_1+offset_2)] = z.x.array[:offset_2]
        x.array[(offset_1+offset_2):(offset_1+offset_2+offset_3)] = v.x.array[:offset_3]
        x.array[(offset_1+offset_2+offset_3):] = p.x.array[:(len(x.array_r) - (offset_1+offset_2+offset_3))]
        ...
        while n < max_iter:
            ...
            z.x.array[:offset_2] = x.array[offset_1:(offset_1+offset_2)]
            v.x.array[:offset_3] = x.array[(offset_1+offset_2):(offset_1+offset_2+offset_3)]
            p.x.array[:(len(x.array_r) - (offset_1+offset_2+offset_3))] = x.array[(offset_1+offset_2+offset_3):]
            u.x.scatter_forward()
            z.x.scatter_forward()
            v.x.scatter_forward()
            p.x.scatter_forward()
