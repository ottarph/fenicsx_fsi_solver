...
def create_mesh(
    ...
    """Generate the DFG 2D-1/2-2 benchmark mesh (adapted from the DOLFINx
    tutorial) and write it to
    ``data/meshes/dfg2d_alt/mesh_<quad|tri><_coarse>.xdmf``.
    ...
    mesh_order:
        Polynomial order of the mesh geometry.
    coarse:
