...
def create_mesh(quads: bool = False):
    """Generate the classic DFG 2D-1/2-2 benchmark mesh (single fluid
    domain around a cylindrical obstacle) and write it to
